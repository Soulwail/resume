...
Page({
  ...
  data: {
    ...
    project: [
      ...
      {
        name: '艾升尔世官方网站',
        desc: '该网站是为化学公司设计的网站，主要介绍该公司的公司信息、相关产品、产品涉及领域以及公司的相关新闻。网站主体采用 Element UI 的 Layout 布局，将各个功能按模块展示，部分表格信息则采用 Grid 布局。技术栈包括了 Vue、Element UI、i18n、EChart等。项目的中英文翻译采用 i18n 来实现，大大减少了项目的代码以及工作量，并且使用 vue-router 进行多级菜单以及页面的切换控制。',
